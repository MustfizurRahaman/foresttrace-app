      ...
      <div className="module-section">
        <details className="range-dropdown">
          ...
          <div className="range-panel">
            {/* The "Outline all ranges" switch used to sit here. A selected
                range now always draws its own boundary, which is what the
                toggle was really for -- habitat appearing with no outline
                around it reads as a bug. Outlining the ranges you have NOT
                selected turned out to be a separate, rarer question, and one
                switch doing both jobs made neither obvious. */}

            {/* Loads habitat for all 25 FMUs the seven ranges span. */}
